...
tract_trend <- tract_trend %>%
  filter(population > 0) %>%
  mutate(date = lubridate::ymd(date), vacc_pop_05da = as.numeric(vacc_pop_05da)) 
```
...
ITS_model <- function(id, tract, interruption_date, start_or_end, age, race, gender, name) {
  ...
  if (grepl("18to65", age)) {
    ...
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_18to65), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
  ...
  if (grepl("under18", age)) {
   # get the time series
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_under18), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
  ...
  if (grepl("black", race)) {
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_black), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
  ...
  if (grepl("aian", race)) {
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_aian), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
  ...
  if (grepl("hispanic", race)) {
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_Ehispanic), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
  ...
  if (grepl("asian", race)) {
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_asian), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
...
# the whole population
  # get the time series
    ...
    # mark the interruption date
    abline(v = TS_data[interruption_index, 2] - 1, col = "firebrick", lty = 2) 
    text(TS_data[interruption_index, 2] - 1, max(TS_data_new$vaccinations_day), paste(interruption_type, "of Encouragement"), col = "firebrick", cex = 1.3, pos = 4)
